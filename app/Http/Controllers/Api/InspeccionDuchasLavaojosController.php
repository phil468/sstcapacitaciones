...
use App\Models\DetalleInspeccionDuchasLavaojos;
// use App\Models\Inspecciones\Luces\ParteLuzEmergencia;
use App\Models\InspeccionDuchasLavaojos;
// use App\Models\Inspecciones\Luces\InspeccionLuzResponsable;
use Carbon\Carbon;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Response;

class InspeccionDuchasLavaojosController extends Controller
{
    public function index()
    {
        return response()->json(
            InspeccionDuchasLavaojos::with(
                'detalles',
                'inspector', 
                'area',
                'empresa',
    ...
    {
        $inspeccion = InspeccionDuchasLavaojos::with(
                'detalles', 
                'inspector', 
                'area',
                'empresa',
    ...
    public function store(Request $request)
    {
        ...
        $inspeccion = InspeccionDuchasLavaojos::create($data);
    ...
    {
        $inspeccion = InspeccionDuchasLavaojos::find($id);
        ...
        if ($request->has('detalles')) {
            ...
            // DetalleInspeccionDuchasLavaojos::whereNotIn('id', $detallesUUIDs)->delete();
            ...
            foreach ($request->detalles as $detalle) {
                $existingDetalle = 
                DetalleInspeccionDuchasLavaojos::where('id', $detalle['id'])->first();
                if ($existingDetalle) {
    ...
    {
        $inspeccion = InspeccionDuchasLavaojos::findOrFail($id);
        $inspeccion->delete();
    ...
    // {
    //     $inspeccion = InspeccionDuchasLavaojos::findOrFail($id);
    //     $exporter = new InspeccionDuchasLavaojosExport($inspeccion);
