    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="rounded-2xl card">
                ...
                <div class="card-body">
                        @can('crear-alertas')
                        @include('livewire.alertas.create')
                        @endcan						
                        @can('editar-alertas')
                        @include('livewire.alertas.update')
                        @endcan
                    ...
                    <table class="table table-striped table-hover table-sm">
                        <thead class="thead">
                            <tr> 
                                ...
                                <th>Condición</th>
                                <th>Campo</th>
                                @can('editar-alertas','borrar-alertas')
                                <th>ACCIONES</th>								
                                @endcan
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div class="btn-group">
                                    ...
                                    @endcan
                                    @can('borrar-alertas')							 
                                    <a class="btn btn-sm btn-danger rounded-xl" onclick="confirm('Confirma borrar Alerta : {{$row->name}}? \nAlertas borrados no pueden ser recuperados!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"> Borrar </a> 
                                    @endcan  
                                </div>
                                </td>
                                @endcan
