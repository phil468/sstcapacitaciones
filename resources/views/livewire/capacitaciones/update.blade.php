                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-3 col-xl-2">
                            ...
                            <label class="mb-4 checkbox-container">
                                <input wire:model="activo" type="checkbox" class="custom-checkbox" id="activo"
                                    style="display: none;">
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-3 col-xl-2">
                            @can('ingresar-capacitaciones-de-aula-virtual')
                                @can('ingresar-capacitaciones-de-no-aula-virtual')
                                    ...
                                    <label class="mb-4 checkbox-container">
                                        <input wire:model="es_aula_virtual" type="checkbox" class="custom-checkbox"
                                            id="es_aula_virtual" style="display: none;">
                                        <span class="checkmark"></span>
                                    </label>
                                    @error('es_aula_virtual')
                                        <span class="error text-danger">{{ $message }}</span>
                                    @enderror
                                @endcan
                            @endcan
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                            ...
                            <div wire:ignore>
                                <select name="status_id" class="form-control" id="status_id" placeholder="Estado">
                                </select>
                            </div>
                            @error('status_id')
                                <span class="error text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                            ...
                            <div wire:ignore>
                                <select name="empresa_id" class="form-control" id="empresa_id" placeholder="Empresas">
                                </select>
                            </div>
                            @error('empresa_id')
                                <span class="error text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4"
                            ...
                            <div wire:ignore>
                                <select name="sede_id" class="form-control" id="sede_id" placeholder="Sede">
                                </select>
                            </div>
                            @error('sede_id')
                                <span class="error text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                            ...
                            <div wire:ignore>
                                <select name="modalidad_id" class="form-control" id="modalidad_id"
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                            ...
                            <div wire:ignore>
                                <select name="capacitaciones_tipo_id" class="form-control" id="capacitaciones_tipo_id"
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                            ...
                            <div wire:ignore>
                                <select name="tema_id" class="form-control" id="tema_id" placeholder="Tema">
                                </select>
                            </div>
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                            ...
                            <input wire:model="fecha_fin" type="datetime-local" class="form-control" id="fecha_fin"
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4"
                            ...
                            <div class="form-check">
                                Interno
                                <label class="switch">
                                    <input type="checkbox" wire:model="expositor_externo" id="expositor_externo"
                                        name="expositor_externo" value="1">
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4"
                            ...
                            <div wire:ignore>
                                <select name="expositor_id" class="form-control" id="expositor_id"
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4"
                            ...
                            <div wire:ignore>
                                <select name="cargo_expositor_id" class="form-control" id="cargo_expositor_id"
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4"
                            ...
                            <input @if (!$expositor_externo) disabled @endif
                                wire:model.defer="nombre_expositor_externo" class="form-control"
                                id="nombre_expositor_externo" placeholder="Nombre Expositor Externo">
                            @error('nombre_expositor_externo')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4"
                            ...
                            <div wire:ignore>
                                <select name="area_id" class="form-control" id="area_id" placeholder="Area"
                                    multiple>
                                </select>
                            </div>
                            @error('area_id')
                        ...
                        @can('ingresar-capacitaciones-de-aula-virtual')
                            <div @if ($es_aula_virtual) class="col-12" @else class="d-none" @endif>
                                <br>
                                <div class="mt-2 h5">
                                ...
                                <div class="mt-2 row">
                                    <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                                        ...
                                        <label class="mb-4 checkbox-container">
                                            <input wire:model="es_onboarding" type="checkbox" class="custom-checkbox"
                                                id="es_onboarding" style="display: none;">
                                            <span class="checkmark"></span>
                                        </label>
                                        @error('es_onboarding')
                                            <span class="error text-danger">{{ $message }}</span>
                                    ...
                                    <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                                        <label for="cantidad_de_preguntas_a_mostrar">Cantidad de preguntas a
                                            mostrar*</label>
                                        <input wire:model.defer="cantidad_de_preguntas_a_mostrar" type="number"
                                            class="form-control" id="cantidad_de_preguntas_a_mostrar"
                                            placeholder="Cantidad de preguntas a mostrar">
                                        <small id="cantidad_de_preguntas_a_mostrar_help" class="form-text text-muted">Por
                                            defecto: {{ $cantidad_de_preguntas_a_mostrar_general }}</small>
                                        @error('cantidad_de_preguntas_a_mostrar')
                                            <span class="error text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                                        ...
                                        <input wire:model.defer="nota_minima_aprobatoria" type="number"
                                            class="form-control" id="nota_minima_aprobatoria"
                                            placeholder="Nota mínima aprobatoria">
                                        <small id="nota_minima_aprobatoria_help" class="form-text text-muted">Por defecto:
                                            {{ $nota_minima_aprobatoria_general }}</small>
                                        @error('nota_minima_aprobatoria')
                                            <span class="error text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12 col-md-12 col-lg-6 col-xl-4">
                                        ...
                                        <input wire:model.defer="intentos_de_evaluacion" type="number"
                                            class="form-control" id="intentos_de_evaluacion"
                                            placeholder="Intentos de evaluación">
                                        <small id="intentos_de_evaluacion_help" class="form-text text-muted">Por defecto:
                                            {{ $intentos_de_evaluacion_general }}</small>
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-3 col-xl-2">
                            ...
                            <label class="mb-4 checkbox-container">
                                <input wire:model="visible" type="checkbox" class="custom-checkbox" id="visible"
                                    style="display: none;">
                                <span class="checkmark"></span>
                            </label>
                            @error('visible')
