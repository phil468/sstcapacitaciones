...
@section('title', 'Importar Capacitaciones')
...
<div class="card rounded-xl">
    <div class="text-white card-header bg-vanguard rounded-t-xl">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div class="float-left">
                <h5 class="h5">Importar Capacitaciones</h5>
            </div>
        </div>
    </div>
    ...
    {{-- <div class="card-body">
        ...
        <form action="{{ route('capacitaciones.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="file" name="file" required>
            <br>
            <br>
            <button type="submit" class="btn btn-vanguard">Importar</button>
            <button type="button" class="btn btn-default" onclick="window.location='{{ route('capacitaciones') }}'">Cancelar</button>
        </form>
    </div> --}}
