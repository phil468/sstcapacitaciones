	...
	<div class="row justify-content-center">
		<div class="col-md-12">
            <div class="rounded-2xl card">
                <div class="text-white card-header bg-vanguard rounded-t-xl">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						<div class="float-left">
							<h4 class="h5">Lista Notificacione </h4>
						</div>
						{{--<div wire:poll.1s>
				...
				<div class="card-body">
						@can('crear-notificaciones')
						@include('livewire.notificaciones.create')
						@endcan						
						@can('editar-notificaciones')
						@include('livewire.notificaciones.update')
						@endcan
					...
					<table class="table table-striped table-hover table-sm">
						<thead class="thead">
							<tr> 
								...
								@can('editar-notificaciones','borrar-notificaciones')
								<th>ACCIONES</th>								
								@endcan
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<div class="btn-group">
									...
									@endcan
									@can('borrar-notificaciones')							 
									<a class="btn btn-sm btn-danger rounded-xl" onclick="confirm('Confirma borrar Notificacione : {{$row->name}}? \nNotificaciones borrados no pueden ser recuperados!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"> Borrar </a> 
									@endcan  
								</div>
								</td>
								@endcan
