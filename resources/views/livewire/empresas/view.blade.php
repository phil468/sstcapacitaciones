					...
					<table class="table table-striped table-hover table-sm">
						<thead class="thead">
							<tr> 
								...
								@can('editar-empresa','borrar-empresa')
								<th>ACCIONES</th>								
								@endcan
							</tr>
						</thead>
