    ...
    <div class="modal-dialog" role="document">
        <div class="rounded-2xl modal-content">
            <div class="text-white modal-header bg-vanguard rounded-t-2xl">
                <h5 class="h5 modal-title" id="updateModalLabel">Actualizar Opcione</h5>
            ...
            <div class="form-group">
                ...
                <input wire:model.defer="opcion" type="text" class="form-control" id="opcion" placeholder="Opcion">@error('opcion') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input wire:model.defer="optionid" type="text" class="form-control" id="optionid" placeholder="Optionid">@error('optionid') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
