    ...
    <div class="modal-dialog" role="document">
        <div class="rounded-2xl modal-content">
            ...
            <div class="form-group">
                ...
                <input wire:model.defer="name" type="text" class="form-control" id="name" placeholder="Name" readonly>@error('name') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
