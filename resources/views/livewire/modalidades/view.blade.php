                ...
                <div class="text-white card-header bg-vanguard rounded-t-xl">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						<div class="float-left">
							<h5 class="h5">Lista Modalidad </h4>
						</div>
						{{--<div wire:poll.1s>
					...
					<table class="table table-striped table-hover table-sm">
						<thead class="thead">
							<tr> 
								...
								@can('editar-modalidad','borrar-modalidad')
								<th>ACCIONES</th>								
								@endcan
							</tr>
						</thead>
						<tbody>
							...
							<tr>								
								...
								<div class="btn-group">
									...
									@endcan
									@can('borrar-modalidad')							 
									<a class="btn btn-sm btn-danger rounded-xl" onclick="confirm('Confirma borrar Modalidade : {{$row->name}}? \nModalidades borrados no pueden ser recuperados!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"> Borrar </a> 
									@endcan  
								</div>
								</td>
								@endcan
