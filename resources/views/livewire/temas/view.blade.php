						...
						<tbody>
							...
							<tr>
								...
								<div class="btn-group">
									...
									@endcan
									@can('borrar-tema')							 
									<a class="btn btn-sm btn-danger rounded-xl" onclick="confirm('Confirma borrar Tema : {{$row->name}}? \nTemas borrados no pueden ser recuperados!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"> Borrar </a> 
									@endcan  
								</div>
								</td>
								@endcan
