<div x-data="{
    ...
    <span x-cloak x-show="edit">
        <input class="w-full px-2 py-1 -mx-2 -my-1 bg-gray-200 border-blue-400 rounded focus:outline-none focus:border-blue-400" x-ref="input" value="{!! htmlspecialchars($value) !!}"
