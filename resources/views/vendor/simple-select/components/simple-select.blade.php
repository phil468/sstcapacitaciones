    ...
    > 
        ...
        @isset($attributes['multiple'])            
            <div x-show="selected && typeof selected === 'object' && selected.length > 0" class="flex flex-wrap space-x-1">
                <template x-for="(value, index) in selected" :key="index">
                    <div class="text-gray-800 dark:text-gray-400 rounded-full truncate bg-gray-300 dark:bg-gray-800 px-2 flex flex-row items-center">
        ...
        @else            
            <div x-show="selected" class="flex flex-wrap"> 
                <div class="text-gray-800 dark:text-gray-400 rounded-sm w-full truncate px-2 flex flex-row items-center">
